...
class HandDetector:
    ...
    def process_frame(self, img, draw=True):
        """
        Processes the image to detect hands.
    ...
    def get_positions(self, img, hand_no=0, draw=True):
        """
        Get the positions of landmarks for a specific hand.
        :param img: Image (used for dimensions)
        :param hand_no: Index of the hand to get positions for
